...
const NoticationScreenView = ({
  ...
  const mPatientList = invites.filter((item) => item.isAccepted === false);
          ...
          <View style={styles.modal}>
            <View style={styles.header}>
              <View style={styles.headerContent}>
                ...
                <Text style={styles.modalTitle}>
                  {modalContent
                    ? `Patient: ${modalContent.patient.firstName} ${modalContent.patient.lastName}`
                    : ''}
                </Text>
              </View>
            </View>
